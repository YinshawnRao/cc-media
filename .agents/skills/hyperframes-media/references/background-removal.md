...
Optional upstream technique. Confirm CLI availability with the actual project pin before using it; outputs stay in project assets. This does not select a narration or ASR engine.
