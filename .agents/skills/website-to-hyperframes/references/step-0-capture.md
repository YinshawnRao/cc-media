...
```bash
npx --yes hyperframes@0.6.69 capture <URL> -o <project-dir>/capture
```

Example: `npx --yes hyperframes@0.6.69 capture https://stripe.com -o videos/stripe-launch/capture`
