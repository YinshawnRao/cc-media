...
Put a headline _behind_ a presenter so their silhouette occludes the text. Requires a transparent cutout produced by `npx --yes hyperframes@0.6.69 remove-background presenter.mp4 -o presenter.webm`.
