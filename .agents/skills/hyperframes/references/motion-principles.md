...
- Choose entrance motion only when useful; a consistent pattern may suit the piece.
...
Static images are valid. When movement serves the scene, possible treatments include:
