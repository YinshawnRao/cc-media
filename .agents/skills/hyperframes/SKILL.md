...
For covers, first evaluate this project's existing footage for title/theme fit, high clarity, a clean image and a composition that works with text. Suitable footage that passes aesthetic review may be used directly, moving or held as a still, without AIGC or a tool-unavailability exception. If no clip meets that standard, default to text-free AIGC still artwork with HTML text and a hold during the opening narration. Preserve the opening narration and cover-viewing pace; this selection rule does not require motion or shorter holds. Follow the repository [cover workflow](../../../CONVENTIONS.md#封面选材与制作流程).
