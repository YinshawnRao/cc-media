...
The clip start is back-solved so the selected sung section starts about two
seconds before the transition narration ends, then the full-volume showcase
continues on real singing.
"""
import contextlib
import json
import subprocess
