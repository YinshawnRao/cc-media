#!/usr/bin/env python3
"""Build master.wav and HyperFrames HTML for 陈小春最被低估的5首歌.
...
# intro/outro footage (diversified: intro=献世 close-up, outro=下半辈子 room)
INTRO_SRC = "vert_xianshi"
INTRO_SEEK = 134.0
OUTRO_SRC = "vert_xiabanbeizi"
OUTRO_SEEK = 95.0
...
items = [
    {
        "key": "p5_buzai", "clip": "vert_buzai", "no": "05",
        "name": "《不在服务区》", "plain": "不在服务区", "meta": "独家记忆 · 2008",
        "show": 26.0, "ch_off": 105.0,
        "tag": "成年人关系里的失联感",
        "note": "不是不爱了，而是再也联系不上",
    },
    {
        "key": "p4_fengliu", "clip": "vert_fengliu", "no": "04",
        "name": "《风流》", "plain": "风流", "meta": "Sing 十年纪念 · 2006",
        "show": 31.0, "ch_off": 177.0,
        "tag": "潇洒背后，藏着没说出口的事",
        "note": "江湖气、男人味，还有一点玩世不恭",
    },
    {
        "key": "p3_yaren", "clip": "vert_yaren", "no": "03",
        "name": "《哑忍》", "plain": "哑忍", "meta": "Sing 十年纪念 · 2006",
        "show": 33.0, "ch_off": 180.0,
        "tag": "把不甘，硬生生压下去",
        "note": "他的沙哑，最适合唱忍着不说",
    },
    {
        "key": "p2_xiabanbeizi", "clip": "vert_xiabanbeizi", "no": "02",
        "name": "《下半辈子》", "plain": "下半辈子", "meta": "That's Mine · 2002",
        "show": 26.0, "ch_off": 183.0,
        "tag": "把后半生，放进一句承诺",
        "note": "不甜，却很真的深情",
    },
    {
        "key": "p1_xianshi", "clip": "vert_xianshi", "no": "01",
        "name": "《献世》", "plain": "献世", "meta": "夜生活 · 2004",
        "show": 33.0, "ch_off": 183.5,
        "tag": "卑微到自嘲，却还是放不下",
        "note": "不靠漂亮音色，靠认输之后的嘴硬",
    },
]
...
body += (
    ...
    '<div><div class="eyebrow">华语遗珠 · 山鸡哥的另一面</div><h1>陈小春<br><b>最被低估</b>的5首歌</h1>'
    '<p class="sub">他不只是又凶又痞的硬汉，情歌里藏着粗粝、卑微，也意外深情的另一面。</p></div>'
    '<div class="chips"><span>江湖气</span><span>卑微深情</span><span>粤语遗珠</span><span>失联感</span><span>认输的温柔</span></div></section>'
)
body += "\n" + "\n".join(labels)
body += (
    f'\n<section id="outro" class="clip" data-start="{outro_start}" data-duration="{q(total-outro_start)}" data-track-index="2">'
    '<div class="small">最终榜单</div><h2>陈小春从不只是山鸡哥，他的情歌里，藏着江湖男人很少示人的卑微、脆弱和深情。</h2>'
    f'<ol>{ranking_rows}</ol><p class="close">这些被大热歌盖住的遗珠，刚好补全了他更复杂的另一面。</p></section>'
)
body += (
...
(ROOT / "meta.json").write_text(json.dumps({
    "id": "main", "name": "chenxiaochun-underrated-top5",
