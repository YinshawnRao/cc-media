#!/usr/bin/env python3
"""Cut letterboxed showcase footage and extract per-song audio windows."""
import json
import subprocess
...
LB = (
    ...
    "gblur=sigma=28,eq=brightness=-0.30:saturation=1.05[bgb];"
    "[fg]scale=1080:-2[fgs];"
...
for s in cfg.SONGS:
    ...
    # Synchronized same-source footage.
