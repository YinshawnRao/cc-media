#!/usr/bin/env bash
set -euo pipefail
cd /Users/yinshawnrao/explorer/cc-media/sandbox/zhangxinzhe-saddest-top5
...
ffmpeg -v error -i renders/full_raw.mp4 -i master.wav -map 0:v -map 1:a -c:v copy -c:a aac -b:a 192k -shortest "renders/${SLUG:-zhangxinzhe-saddest-top5}.mp4" -y
ffprobe -v error -show_entries format=duration -of csv=p=0 "renders/${SLUG:-zhangxinzhe-saddest-top5}.mp4"
