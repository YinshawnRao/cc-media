...
BLOCKS = {
    ...
    "p5_wobuyao": "第五名，《我不要》。它来自《向前冲》，但同张专辑里《向前冲》《怪兽》《妙妙妙》更容易被记住。它最动人的不是委屈，也不是纠缠，而是很直接地说，我不要。像一个女生终于把自己从消耗里拉出来。",
    ...
    "outro": "最后把榜单完整收一次。第五，我不要；第四，等不及；第三，乱了；第二，友情卡片；第一，温习。徐怀钰最被低估的部分，也许正是这些不只靠明亮和元气成立的歌。它们让人听见，她也可以直接，可以锋利，也可以安静地留下后劲。",
