...
set -e
P=/Users/yinshawnrao/explorer/cc-media/sandbox/dingshiguang-others-top5
cd "$P"
RAW=hf/renders/full_raw.mp4
FINAL=renders/dingshiguang-others-top5.mp4
...
for pair in cover:0.5 hook:8 s5card:30 s5chorus:48 s4card:67 s4chorus:87 \
            s3card:107 s3chorus:127 s2card:146 s2chorus:166 s1card:186 s1chorus:207 outro:233; do
  k=${pair%%:*}; t=${pair##*:}
