...
用法: python3 tools/video/check_yt_cookie.py [cookie文件]  (默认 sandbox/www.youtube.com_cookies.txt)
...
def main():
    path = sys.argv[1] if len(sys.argv) > 1 else "sandbox/www.youtube.com_cookies.txt"
